...
export const Box = styled.View<BoxProps>`
  ...
  ${(props) =>
    props.pH !== undefined && `padding-left: ${sizeToPx(props.pH)}px; padding-right: ${sizeToPx(props.pH)}px`};
  ${(props) =>
    props.pV !== undefined && `padding-top: ${sizeToPx(props.pV)}px; padding-bottom: ${sizeToPx(props.pV)}px; `};
