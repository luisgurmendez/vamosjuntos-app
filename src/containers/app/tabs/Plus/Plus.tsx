...
const PlusBtn: React.FC = () => {
  ...
  return (
    <PlusButtonContainer>
      <Portal>
        <AnimatedPlusButton ref={plusBtnRef} style={getPlusButtonAnimation()} activeOpacity={1} onPress={() => setShowMenu(s => !s)}>
          <Icon name="plus" size={30} color={colors.white} />
        </AnimatedPlusButton>
        <RadialButtonGroup show={showMenu} style={{ zIndex: 30, position: 'absolute', bottom: 0, alignSelf: 'center' }} distance={100}>
          <OptionButton
